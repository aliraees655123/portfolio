      ...
      <motion.div
        ...
        <form
          ...
          <label className="flex flex-col">
            ...
            /> */}
            <p  className="bg-eerieBlack py-4 px-6
              placeholder:text-taupe
              text-timberWolf rounded-lg outline-none
              border-none font-medium">Ali Raees</p>
          </label>
          <label className="flex flex-col">
            ...
            <p  className="bg-eerieBlack py-4 px-6
              placeholder:text-taupe
              text-timberWolf rounded-lg outline-none
              border-none font-medium">ali.raees500@gmail.com</p>
          </label>
          <label className="flex flex-col">
            ...
            <p  className="bg-eerieBlack py-4 px-6
              placeholder:text-taupe
              text-timberWolf rounded-lg outline-none
              border-none font-medium">+923486615792</p>
          </label>
